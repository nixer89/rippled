  ...
  if (is_clang)
    ...
    if (LLVM_COV AND LLVM_PROFDATA)
      add_custom_target (coverage_report
        ...
        COMMAND ${CMAKE_COMMAND} -E echo "Running xrpld tests."
        COMMAND xrpld --unittest$<$<BOOL:${coverage_test}>:=${coverage_test}> --quiet --unittest-log
        ...
        COMMAND ${LLVM_COV}
          ...
          $<TARGET_FILE:xrpld> ${extract_pattern}
  ...
  elseif (is_gcc)
    ...
    if (LCOV AND GENHTML)
      add_custom_target (coverage_report
        ...
        # run tests
        COMMAND ${CMAKE_COMMAND} -E echo "Running xrpld tests for coverage report."
        COMMAND xrpld --unittest$<$<BOOL:${coverage_test}>:=${coverage_test}> --quiet --unittest-log
