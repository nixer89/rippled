if(reporting)
    ...
    if(NOT PostgreSQL_FOUND)
        ...
        if(NOT libpq-fe_FOUND OR NOT postgres_FOUND)
            ...
            target_link_libraries(xrpl_libs INTERFACE postgres pgcommon pgport)
        else()
            message("Found system installed Postgres via find_libary")
            target_include_directories(xrpl_libs INTERFACE ${libpq-fe})
            target_link_libraries(xrpl_libs INTERFACE ${postgres})
        endif()
    else()
        message("Found system installed Postgres via find_package")
        target_include_directories(xrpl_libs INTERFACE ${PostgreSQL_INCLUDE_DIRS})
        target_link_libraries(xrpl_libs INTERFACE ${PostgreSQL_LIBRARIES})
    endif()
endif()
